      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              Image(image: AssetImage('assets/images/kanvastablo.jpg'),
                height:30,
                width:100,
              ),
              Text('Kanvas Tablo',
      ...
      child: Row(
        ...
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Image(image: AssetImage('assets/images/muzikkutusu.jpg'),
                height:30,
                width:100,
              ),
              Text('Müzik Kutusu',
      ...
      child: Row(
        ...
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Image(image: AssetImage('assets/images/palet.jpg'),
                height:30,
                width:100,
              ),
              Text('Palet',
      ...
      child: Row(
        ...
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Image(image: AssetImage('assets/images/sovalye.jpg'),
                height:30,
                width:100,
              ),
              Text('Şövalye',
