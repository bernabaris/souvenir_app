        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: (){
                Navigator.pushReplacement(context, MaterialPageRoute(builder: (BuildContext context) => LineChartSample1()));
              },
            ),
      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              Image(image: AssetImage('assets/images/suluboya.jpg'),
              height:30,
              width:100,
              ),
              Text('Sulu Boya',
      ...
      child: Row(
        ...
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Image(image: AssetImage('assets/images/kuruboya.jpg'),
                height:30,
                width:100,
              ),
              Text('Kuru Boya',
      ...
      child: Row(
        ...
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Image(image: AssetImage('assets/images/pastelboya.jpeg'),
                height:30,
                width:100,
              ),
              Text('Pastel Boya',
      ...
      child: Row(
        ...
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Image(image: AssetImage('assets/images/fircaseti.jpg'),
                height:30,
                width:100,
              ),
              Text('Fırça Seti',
