      ...
      child: Row(
        ...
        children: [
          Column(
            ...
            children: [
              Image(image: AssetImage('assets/images/fotokopikagidi.jpg'),
                height:30,
                width:100,
              ),
              Text('Fotokopi Kağıdı',
      ...
      child: Row(
        ...
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Image(image: AssetImage('assets/images/hesapmakinesi.jpg'),
                height:30,
                width:100,
              ),
              Text('Hesap Makinesi',
      ...
      child: Row(
        ...
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Image(image: AssetImage('assets/images/kecelikalem.jpg'),
                height:30,
                width:100,
              ),
              Text('Keçeli Kalem',
      ...
      child: Row(
        ...
        children: [
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Image(image: AssetImage('assets/images/akrilikboya.jpg'),
                height:30,
                width:100,
              ),
              Text('Akrilik Boya',
